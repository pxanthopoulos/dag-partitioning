...
protected:
     ...
     * @return true if clustering should continue, false if minimum vertices stopping criteria met
     */
...
public:
    ...
    /**
     * @brief Executes the clustering algorithm, while checking for the stopping criteria
     * @return Stack of intermediate clustering results, with each entry containing:
